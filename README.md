...
## 6-Подготовка виртуальных машин к управлению через SSH
...
```
На всех машинах добавляем еще один адаптер ansible

Задайте IP созданным интерфейсам из не существующей подсети. Например из 10.15.15.0/24

Настройка  подключения по ssh к виртуальным машинам под пользователем root
...
Теперь проверяем что с виртуальной машины ansible можем подключиться ко всем другим вируальным машинам ssh root@IP виртуальной машины
